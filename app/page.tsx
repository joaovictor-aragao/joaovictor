  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col-reverse md:flex-row items-center gap-12 text-center md:text-left">
          ...
          <div className="flex-1 space-y-6">
            ...
            <p className="text-lg text-gray-300 max-w-xl mx-auto md:mx-0 mt-4">
            ...
            <div className="pt-6">
              {/* <h3 className="text-base tracking-wider mb-4">Contact me</h3> */}
      ...
      <section id="about" className="py-24 bg-black/50">
        <div className="container mx-auto px-5">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Imagem – visível só em telas grandes */}
            {/* <div className="hidden lg:flex justify-center">
              <div className="p-1 border-[#1e1e1e] bg-[#1e1e1e] shadow">
          ...
          <div className="hidden lg:grid grid-cols-3 gap-6 place-items-center">
            ...
            <div className="space-y-6">
              <p className="text-gray-300 text-justify leading-relaxed indent-px">
                Statistician graduated from UFPI, with extensive experience in creating and implementing analytical
                solutions for complex business challenges, ranging from large-scale data storage to statistical
                modeling, risk analysis, and machine learning.
              </p>
              ...
              <p className="text-gray-300 text-justify leading-relaxed">
                I have a profile focused on results, with the ability to
              ...
              <p className="text-gray-300 text-justify leading-relaxed">
              Outside of work, I'm a curious and enthusiastic learner who enjoys exploring new interests.
              I like watching TV shows and movies like Star Wars, The Lord of the Rings, and Harry Potter, and occasionally unwinding with creative hobbies.
              </p>

              <p className="text-gray-300 font-semibold">May the force be with you!</p>
            </div>
          </div>
        </div>
      </section>
